...
### 1. DNS Configuration
Before deploying, ensure your domain `aplanalyst.in` points to your VPS IP address (`209.145.53.86`).
1. Log into your domain registrar's DNS management console.
2. Add an **A Record** for the root domain (`@`) pointing to `209.145.53.86`.
3. Add a second **A Record** (or CNAME) for the `www` subdomain pointing to `209.145.53.86`.
